...
//  DataStructures
//
//  Created by Barnes, Cade on 3/29/18.
...
else
{
    ...
    insertMe->setRooteNode(previous);
}
}
...
template <class Type>
int BinarySearchTree<Type> :: calcualteHeight(BinaryTreeNode<Type> * current)
{
    if(current != nullptr)
    {
...
void BinarySearchTree<Type> :: remove(Type getRidOfMe)
{
    ...
    {
        cout << "Empty tree so removal not possible" << endl;
    }
    else
    {
        BinaryTreeNode<Type> * current = this->root;
...
void BinarySearchTree<Type> :: removeNode(BinaryTreeNode<Type> * removeMe)
{
    ...
    if(removeMe->getRightNode() == nullptr && removeMe->getLeftNode() == nullptr && removeMe->getLeftNode() == nullptr)
    {
        temp = removeMe;
        removeMe = nullptr;
...
template <class Type>
Type BinarySearchTree<Type> :: find Minimum()
{
    assert(this->root != nullptr);
